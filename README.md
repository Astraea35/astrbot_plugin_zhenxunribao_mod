# 真寻日报魔改版 (astrbot_plugin_zhenxunribao_mod)
...
这是一个从 [nonebot-plugin-zxreport](https://github.com/HibiKier/nonebot-plugin-zxreport) 移植并魔改重构的 AstrBot 真寻日报插件。插件会每日为你汇总最新的资讯内容，包含今日新番、B站热点、世界新闻、IT资讯、摸鱼日历和今日一言等内容。
...
git clone https://github.com/Astraea35/astrbot_plugin_zhenxunribao_mod
```

2. 安装依赖：
```bash
cd astrbot_plugin_zhenxunribao_mod
...
仓库地址：[https://github.com/Astraea35/astrbot_plugin_zhenxunribao_mod](https://github.com/Astraea35/astrbot_plugin_zhenxunribao_mod)
